...
public class LogJson {
  ...
  public static LogJson fromJson(String json) {
    ...
    LogJson lj = new LogJson((List<List<String>>) gson.fromJson(json, t_list_list_string));
    return lj;
  }
  ...
  public static LogJson fromJson(Reader r) {
    ...
    Type t_list_list_string = TypeToken.getParameterized(List.class, t_list_string).getType();
    @SuppressWarnings("unchecked") 
    LogJson lj = new LogJson((List<List<String>>) gson.fromJson(r, t_list_list_string));
    return lj;
  }
}
